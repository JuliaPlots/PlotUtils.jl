...
# The following are categorical color palettes
register_gradient_colors(:Set2, [
    ...
    RGB(179/255, 179/255, 179/255)], :colorbrewer, true)
...
register_gradient_colors(:Accent, [
    ...
    RGB(102/255, 102/255, 102/255)], :colorbrewer, true)
...
register_gradient_colors(:Set1, [
    ...
    RGB(153/255, 153/255, 153/255)], :colorbrewer, true)
...
register_gradient_colors(:Set3, [
    ...
    RGB(204/255, 235/255, 197/255),
    RGB(255/255, 237/255, 111/255)], :colorbrewer, true)
...
register_gradient_colors(:Paired, [
    ...
    RGB(255/255, 255/255, 153/255),
    RGB(177/255, 89/255, 40/255)], :colorbrewer, true)
...
register_gradient_colors(:Pastel2, [
    ...
    RGB(204/255, 204/255, 204/255)], :colorbrewer, true)
...
register_gradient_colors(:Pastel1, [
    ...
    RGB(242/255, 242/255, 242/255)], :colorbrewer, true)
